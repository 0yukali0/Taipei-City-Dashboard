...
def _transfer(**kwargs):
    ...
    data["accessible_elevator_flag"] = data["accessible_elevator_flag"].map(
        lambda x: True if x == "v" else False
    )
    data["accessible_restroom_flag"] = data["accessible_restroom_flag"].map(
        lambda x: True if x == "v" else False
    )
    data["accessible_stair_handrail_flag"] = data["accessible_stair_handrail_flag"].map(
        lambda x: True if x == "v" else False
    )
    data["type"] = "parking"
    # define columns type
